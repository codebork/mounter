// This code was autogenerated with `dbus-codegen-rust -s -d org.freedesktop.UDisks2 -p /org/freedesktop/UDisks2/block_devices/sda -m None -i org.freedesktop`, see https://github.com/diwic/dbus-rs
use dbus as dbus;
use dbus::arg;
use dbus::blocking;
...
pub trait UDisks2PartitionTable {
    fn create_partition(&self, offset: u64, size: u64, type_: &str, name: &str, options: ::std::collections::HashMap<&str, arg::Variant<Box<dyn arg::RefArg>>>) -> Result<dbus::Path<'static>, dbus::Error>;
    fn create_partition_and_format(&self, offset: u64, size: u64, type_: &str, name: &str, options: ::std::collections::HashMap<&str, arg::Variant<Box<dyn arg::RefArg>>>, format_type: &str, format_options: ::std::collections::HashMap<&str, arg::Variant<Box<dyn arg::RefArg>>>) -> Result<dbus::Path<'static>, dbus::Error>;
    fn partitions(&self) -> Result<Vec<dbus::Path<'static>>, dbus::Error>;
    fn type_(&self) -> Result<String, dbus::Error>;
}

impl<'a, C: ::std::ops::Deref<Target=blocking::Connection>> UDisks2PartitionTable for blocking::Proxy<'a, C> {

    fn create_partition(&self, offset: u64, size: u64, type_: &str, name: &str, options: ::std::collections::HashMap<&str, arg::Variant<Box<dyn arg::RefArg>>>) -> Result<dbus::Path<'static>, dbus::Error> {
        self.method_call("org.freedesktop.UDisks2.PartitionTable", "CreatePartition", (offset, size, type_, name, options, ))
            .and_then(|r: (dbus::Path<'static>, )| Ok(r.0, ))
    }

    fn create_partition_and_format(&self, offset: u64, size: u64, type_: &str, name: &str, options: ::std::collections::HashMap<&str, arg::Variant<Box<dyn arg::RefArg>>>, format_type: &str, format_options: ::std::collections::HashMap<&str, arg::Variant<Box<dyn arg::RefArg>>>) -> Result<dbus::Path<'static>, dbus::Error> {
        self.method_call("org.freedesktop.UDisks2.PartitionTable", "CreatePartitionAndFormat", (offset, size, type_, name, options, format_type, format_options, ))
            .and_then(|r: (dbus::Path<'static>, )| Ok(r.0, ))
    }

    fn partitions(&self) -> Result<Vec<dbus::Path<'static>>, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.freedesktop.UDisks2.PartitionTable", "Partitions")
    }

    fn type_(&self) -> Result<String, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.freedesktop.UDisks2.PartitionTable", "Type")
    }
}
